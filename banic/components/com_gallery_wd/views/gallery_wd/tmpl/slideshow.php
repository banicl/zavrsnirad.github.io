...
$params=$this->params;
    ...
    <style>
      ...
      #bwg_container1_<?php echo $bwg; ?> #bwg_container2_<?php echo $bwg; ?> .bwg_slideshow_title_text_<?php echo $bwg; ?> {
        ...
        line-height: <?php echo $theme_row->slideshow_title_font_size; ?>px;
    ...
    <script>
      ...
      function bwg_popup_resize_<?php echo $bwg; ?>() {
        ...
        if (parent_width >= <?php echo $image_width; ?>) {
		 ...
		 jQuery(".bwg_slideshow_title_text_<?php echo $bwg; ?>").css({lineHeight: (<?php echo $theme_row->slideshow_title_font_size ; ?>+'px')});
          ...
          jQuery(".bwg_slideshow_title_text_<?php echo $bwg; ?>").css({lineHeight: ((parent_width) * <?php echo $theme_row->slideshow_title_font_size / $image_width; ?>+'px')});
