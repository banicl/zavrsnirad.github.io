        ...
        <script type="text/javascript">
            ...
            if (!short_code) { // Insert.
              ...
              switch (short_code['gallery_type']) {
                ...
                case 'album_compact_preview': {
                  ...
                  jQuery("#compuct_album_column_number").val(short_code['album_column_number']);
                  jQuery("#compuct_albums_per_page").val(short_code['albums_per_page']);
                  jQuery("#compuct_album_title_" + short_code['album_title']).attr('checked', 'checked');
                  jQuery("#compuct_album_thumb_width").val(short_code['album_thumb_width']);
                  jQuery("#compuct_album_thumb_height").val(short_code['album_thumb_height']);
                  jQuery("#compuct_album_image_column_number").val(short_code['image_column_number']);
                  jQuery("#compuct_album_images_per_page").val(short_code['images_per_page']);
                  jQuery("#compuct_album_image_title_" + short_code['image_title_show_hover']).attr('checked', 'checked');
                  jQuery("#compuct_album_image_thumb_width").val(short_code['thumb_width']);
                  jQuery("#compuct_album_image_thumb_height").val(short_code['thumb_height']);
                  if (short_code['album_enable_page'] == 1) {
                    jQuery("#compuct_album_page_yes").attr('checked', 'checked');
                  }
                  else {
                    jQuery("#compuct_album_page_no").attr('checked', 'checked');
                  }
                  if (short_code['album_view_type'] == 'thumbnail') {				  
                ...
                case 'album_extended_preview': {
                  ...
                  jQuery("#extended_albums_per_page").val(short_code['albums_per_page']);
                  jQuery("#extended_album_height").val(short_code['extended_album_height']);
                  if (short_code['album_description_enable'] == 1) {
                    jQuery("#extended_album_description_yes").attr('checked', 'checked');
                  }
                  else {
                    jQuery("#extended_album_description_no").attr('checked', 'checked');
                  }
                  jQuery("#extended_album_thumb_width").val(short_code['album_thumb_width']);
                  jQuery("#extended_album_thumb_height").val(short_code['album_thumb_height']);
                  jQuery("#extended_album_image_column_number").val(short_code['image_column_number']);
                  jQuery("#extended_album_images_per_page").val(short_code['images_per_page']);
                  jQuery("#extended_album_image_title_" + short_code['image_title']).attr('checked', 'checked');
                  jQuery("#extended_album_image_thumb_width").val(short_code['thumb_width']);
                  jQuery("#extended_album_image_thumb_height").val(short_code['thumb_height']);
                  if (short_code['album_enable_page'] == 1) {
          ...
          // Get shortcodes attributes.
		   function get_params(module_name) {
			...
			for(key=0; key<key_values.length;key++){
